...
function Skills({refprop}){
    ...
    return(
        <div className="flex flex-col w-screen h-screen place-content-center" ref={refprop}>
            <div className="w-[100%] h-[15%] justify-items-center content-end">
                <p className={`text-[32px] font-semibold font-mono`}>My Skills</p>
            </div>
            <div className="flex flex-row w-[100%] h-[75%] justify-items-center content-center">
                <div className="w-[50%] h-full justify-items-end content-center">
                    <div className="flex flex-col h-full w-[75%] p-2 rounded-lg bg-my_gradient_reversed content-center justify-items-center backdrop-blur-md">
                        ...
                        <div className="flex flex-row h-1/6 items-center">
                            <div className="grid place-content-around justify-items-center w-[40%] h-full p-1" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(20px, 1fr))", gap: "4px"}}>
                                    {
                                        hardskills[i].map((skill,index)=>{
                                            return <img key={index} className={`max-h-14 justify-self`} src={getLogo(skill)}></img>
                                        })
                                    }
                            </div>
                ...
                <div className="w-[50%] h-full justify-items-center content-center">
                    <div className="flex flex-col h-full w-[75%] p-2 rounded-lg bg-my_gradient_reversed justify-items-center backdrop-blur-md text-[16px] max-md:text-[10px]">
